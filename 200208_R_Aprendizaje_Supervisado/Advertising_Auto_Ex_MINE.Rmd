...
lm = lineal model es el primer modelo que vamos a aprender
...
# existe correlación clara y negativa
...
# predictor
# creo new data set con valor de horsepower 98
new_auto = data.frame(horsepower = c(80))
predicted_values <- predict(lm_fit_horsepower_mpg, new_auto, interval = 'confidence')
new_advertising <- cbind(new_advertising, predicted_values)
